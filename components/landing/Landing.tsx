...
export const Landing = () => {
    return (
        <div className="relative flex justify-center w-full">
            ...
            <section className="absolute self-center bottom-32 flex flex-col items-center gap-6 text-center sm:items-start text-white sm:text-left px-2">
                <h1 className="text-xl lg:text-7xl sm:text-2xl md:text-6xl font-semibold leading-15 tracking-tight text-center">
                    Community Registration – CAG Members
                </h1>
                <article>
                    <p className="text-sm max-w-7xl lg:text-2xl sm:text-sm md:text-xl leading-8">
                ...
                <div className='flex gap-4 m-auto'>
                    ...
                    <a target="_blank" href="https://en.godfootsteps.org/" className='m-auto flex-1'>
                        <Button className='md:w-60 md:h-20 bg-gray-200 text-black text-2xl shadow-sm hover:scale-105 hover:bg-gray-100 transition-all duration-75'>Official Website</Button>
                    </a>
                </div>
            </section>
        </div>
